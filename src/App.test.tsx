...
it.each(widths)(
	'should show a list of profiles and then select one with %o viewport',
	async width => {
...
it('redirects home page when trying to access an invalid profile', async () => {
	render(<App />, {route: '/invalid-profile'})
...
it('renders error', async () => {
	queryClient.clear()
	server.use(http.get('/profiles', () => new HttpResponse(null, {status: 500})))
	render(<App />)
